...
SK-SCHOLAR (P2.7) and P2.5 context monitors into the hook system.

Usage:
    import runtime.init_hooks  # registers SK-SCHOLAR + P2.5 monitors
...
After import:
    - HOOK_REGISTRY gains "SK-SCHOLAR" (21 hooks total)
    - ALWAYS_ON_HOOKS gains "SK-SCHOLAR" (3 always-on: SK-REALITY, SK-ENERGY, SK-SCHOLAR)
