...
Multi-agent orchestration for AuDHD cognition. 7 models, skill-based augmentation, LLM-specific adapters.
...
| O-54P | GPT-5.4 Pro | Deep Planner / Analyst |
...
2. Model-specific file (`models/GEMINI.md` or `models/OPENAI.md`)
