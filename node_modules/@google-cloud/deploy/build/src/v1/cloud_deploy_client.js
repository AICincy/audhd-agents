...
class CloudDeployClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('deploy');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            deployPolicyPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/deployPolicies/{deploy_policy}'),
        ...
        this.descriptors.page = {
            ...
            listDeployPolicies: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'deployPolicies'),
        ...
        const createDeployPolicyResponse = protoFilesRoot.lookup('.google.cloud.deploy.v1.DeployPolicy');
        const createDeployPolicyMetadata = protoFilesRoot.lookup('.google.cloud.deploy.v1.OperationMetadata');
        const updateDeployPolicyResponse = protoFilesRoot.lookup('.google.cloud.deploy.v1.DeployPolicy');
        const updateDeployPolicyMetadata = protoFilesRoot.lookup('.google.cloud.deploy.v1.OperationMetadata');
        const deleteDeployPolicyResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDeployPolicyMetadata = protoFilesRoot.lookup('.google.cloud.deploy.v1.OperationMetadata');
        ...
        this.descriptors.longrunning = {
            ...
            createDeployPolicy: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createDeployPolicyResponse.decode.bind(createDeployPolicyResponse), createDeployPolicyMetadata.decode.bind(createDeployPolicyMetadata)),
            updateDeployPolicy: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateDeployPolicyResponse.decode.bind(updateDeployPolicyResponse), updateDeployPolicyMetadata.decode.bind(updateDeployPolicyMetadata)),
            deleteDeployPolicy: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteDeployPolicyResponse.decode.bind(deleteDeployPolicyResponse), deleteDeployPolicyMetadata.decode.bind(deleteDeployPolicyMetadata)),
    ...
    getDeployPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    createDeployPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateDeployPolicyProgress(name) {
    ...
    updateDeployPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateDeployPolicyProgress(name) {
    ...
    deleteDeployPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteDeployPolicyProgress(name) {
    ...
    listDeployPolicies(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listDeployPoliciesStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listDeployPolicies.createStream(this.innerApiCalls.listDeployPolicies, request, callSettings);
    }
    /**
     ...
     */
    listDeployPoliciesAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listDeployPolicies.asyncIterate(this.innerApiCalls['listDeployPolicies'], request, callSettings);
    }
     ...
     * @returns {string} Resource name string.
     */
    deployPolicyPath(project, location, deployPolicy) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromDeployPolicyName(deployPolicyName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromDeployPolicyName(deployPolicyName) {
     ...
     */
    matchDeployPolicyFromDeployPolicyName(deployPolicyName) {
