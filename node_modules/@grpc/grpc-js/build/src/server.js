...
const MAX_CONNECTION_IDLE_MS = 300000; // Default to 5 minutes to prevent idle leakage
    ...
    return _a = class Server {
            constructor(options) {
                ...
                this.sessionIdleTimeout =
                    (_f = this.options['grpc.max_connection_idle_ms']) !== null && _f !== void 0 ? _f : 600000; // Default to 10 mins
